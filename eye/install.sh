...
# Generated by ./aEyes/eys/install.sh
...
apt install -y python3-dev libgl1-mesa-dev libx11-dev
...
echo "Setting desktop background set to $WALLPAPER_PATH"
...
# Fail on error, unset var, or pipe failure
set -Eeuo pipefail
