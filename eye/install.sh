...
# Reduce clocks, setup LCD, setup CAN, rotate display
CFG="/boot/firmware/config.txt"

if [[ "$EYE_ID" == "4" || "$EYE_ID" == "6" ]]; then
    ROT=180
else
    ROT=90
fi
...
echo "Setting display rotation to $ROT"
...
dtoverlay=vc4-kms-dsi-waveshare-panel,4_0_inchC,rotation=$ROT
