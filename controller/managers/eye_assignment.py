...
class EyeAssignmentManager:
    ...
    def _rebalance(self, active_face_ids: list[FaceId], now: float) -> None:
        ...
        strictly more eyes than (ceil(total / n_faces) + 1), move one
        eye back into the available pool so it can be re-assigned later
        via the proximity selection.
        """
