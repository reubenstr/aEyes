...
T_base_camera = T_from_R_t(R_base_camera, t_base_camera_m)
T_base_gimbal = T_from_R_t(R_base_gimbal, t_base_gimbal_m)
...
p_base_m = p_from_homogeneous(
    T_base_camera @ p_to_homogeneous(p_camera_m)
)

# base -> gimbal
T_gimbal_base = T_inverse(T_base_gimbal)
